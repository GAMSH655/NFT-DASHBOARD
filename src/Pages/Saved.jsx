...
import Wave from "../assets/Wave.png"
 const Saved = () => {
   ...
   <div className="">
   <h3 className="capitalize font-normal text-white p-2 text-[1.5rem]  md:text-[2rem]"> saved page
          <span className="block text-white font-normal text-sm">Welcome to saved  page</span>
          </h3>
    <div className=' block md:grid md:grid-cols-4 overflow-x-auto p-4'>
      {
